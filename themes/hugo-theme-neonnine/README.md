...
Neon Nine is a dark-mode theme for Hugo with a heavy neon/vapor feel to it that is based heavily on ![Hugo Theme Nix](https://github.com/LordMathis/hugo-theme-nix) by the amazing ![Matúš Námešný](https://namesny.com/)--hence the name "Neon Nine"--and published under the MIT license.
...
mkdir themes
cd themes
git clone https://github.com/sarahallenreed/hugo-theme-neonnine
```
